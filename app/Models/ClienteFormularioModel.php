...
class ClienteFormularioModel extends Model
{
    ...
    protected $allowedFields    = [
        ...
        'RECEITA_DIVIDENDOS',
        'RECEITA_ALUGUEL',
        'RECEITA_PARTICIPACAO_LUCROS',
        'RECEITA_INSS',
        'RECEITA_PREVIDENCIA_PRIVADA',
        ...
        'DIVIDA_FINANCIAMENTO_RESIDENCIAL_SALDO_DEVEDOR',
        'DIVIDA_FINANCIAMENTO_VEICULO_SALDO_DEVEDOR',
        'DIVIDA_EMPRESTIMO_SALDO_DEVEDOR',
        'DIVIDA_CARTAO_FATURA_SALDO_DEVEDOR',

        'BENS_VALOR_MERCADO_IMOVEL',
        'BENS_VALOR_MERCADO_IMOVEL_ALUGADO',
        'BENS_VALOR_MERCADO_IMOVEL_VERAO',
        'BENS_VALOR_MERCADO_VEICULOS',
        'BENS_VALOR_MERCADO_EMPRESAS',
