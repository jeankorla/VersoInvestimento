  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-6 mb-5 mb-lg-0 text-center">
        <img class="img-fluid mb-4" style="max-width: 50%; margin-top: -60px;" src="<?= base_url('img/logo.svg') ?>" alt="Logo">
        <h1 class="my-1 display-5 fw-bold" style="margin-top: -10px;">
          ...
          <p style="font-size: 2.5vh;">Tenha um processo estruturado de crescimento financeiro e patrimonial feito sob medida para você saber exatamente o que fazer,
