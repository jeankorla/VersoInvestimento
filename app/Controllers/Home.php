...
class Home extends BaseController
{
    ...
    public function salvar()
    {
        ...
        $Registros_ClienteFormularioModel = [
            ...
            'DESPESA_FINANCIAMENTO_RESIDENCIAL_SALDO_DEVEDOR_HIDDEN'    => $this->request->getPost('DESPESA_FINANCIAMENTO_RESIDENCIAL_SALDO_DEVEDOR'),
            'DESPESA_FINANCIAMENTO_VEICULO_PARCELA_HIDDEN'              => $this->request->getPost('DESPESA_FINANCIAMENTO_VEICULO_PARCELA'),
            'DESPESA_FINANCIAMENTO_VEICULO_SALDO_DEVEDOR_HIDDEN'        => $this->request->getPost('DESPESA_FINANCIAMENTO_VEICULO_SALDO_DEVEDOR'),
            ...
            'DESPESA_EMPRESTIMO_SALDO_DEVEDOR_HIDDEN'                   => $this->request->getPost('DESPESA_EMPRESTIMO_SALDO_DEVEDOR'),
